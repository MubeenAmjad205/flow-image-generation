...
def run_pipeline(docx_path: str, headless: bool = False, resume: bool = True, use_cookies: bool = False) -> None:
...
def main():
    ...
    run_pipeline(docx_path=args.input, headless=args.headless, resume=args.resume, use_cookies=args.use_cookies)
